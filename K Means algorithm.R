...
#the model clustered observations into groups of related observations without any prior knowledge of those relationships.
#TASK: Accuracy = number of correctly classified/(total classified) = 7.8235
