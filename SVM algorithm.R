...
#The model took a closer look at the parameters, classified the data by parameters correctly. 
#For this data set it was a good model to use. 
#We also could see the graph, support vector(represented by cross sign and decision boundary, belong to 3 types of species. 
#We also were able to see the predicted class for second 3 types of species.
